...
Connection conn = bustic.ConnecrDb();
    ...
    public void rand(){
        ...
        jTextField4.setText(Integer.toString(rand_int1));
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Surat", "Rajkot", "Amreli", "Vadodra", "Ahmedabad", "Bhavanagar", "Gandhinagar", "Jamnagar" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Surat", "Rajkot", "Amreli", "Vadodra", "Ahmedabad", "Bhavanagar", "Gandhinagar", "Jamnagar" }));
        ...
        jLabel4.setText("-: SELECT BUS :-");

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "New Dharati   8:00PM  8 Hour  500/-", "Payal Travels 8:30PM  8:30 Hour 600/-", "Rajwadi  9:00PM  7:45 Hour 550/-", "Ronak Travels 10:00PM 9:00 Hour 450/-", "New Samay AC-Class 9:20PM 8:00 Hour 700/-" }));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setText("-: SELECT SEAT :-");

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lower", "Upper" }));
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Debit Card", "Credit Card", "Net Banking", "Paytm", "Phone Pay" }));

        jLabel11.setText("COD is not Available...");
        ...
        jComboBox8.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2019", "2020" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql="insert into TIC(Tnum,Fromds,Tods,Pname,Cno,Age,Sbus,Pmod,Sseat,Sul,Date,Totalrs) values(?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            ...
            pst.setString(8,(String) jComboBox5.getSelectedItem());
            pst.setString(9,seat);
            pst.setString(10,(String) jComboBox4.getSelectedItem());
            String d=""+jComboBox6.getSelectedItem()+"/"+jComboBox7.getSelectedItem()+"/"+jComboBox8.getSelectedItem();
            pst.setString(11,d);
            pst.setString(12,jTextField5.getText());
           
            pst.execute();
           
            jTextArea1.setText("Ticket Num :- "+jTextField4.getText()+"\n\n"+"Passenger Name :- "+jTextField1.getText()+"\n\n"
            +"Mobile No:- "+jTextField2.getText()+"\n\n"+"Date :- "+d+"\n\n"+"From :- "+jComboBox1.getSelectedItem()+
                    "\t\t"+"TO :- "+jComboBox2.getSelectedItem()+"\n\n"+"Bus Name :- "+jComboBox3.getSelectedItem()+"\n\n"+"Total Rs/- "+jTextField5.getText()
            +"\n\n"+"Payment Through :- "+jComboBox5.getSelectedItem());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(jComboBox3.getSelectedItem().equals("New Dharati   8:00PM  8 Hour  500/-")){
            total=500;
        }
        else if(jComboBox3.getSelectedItem().equals("Payal Travels 8:30PM  8:30 Hour 600/-")){
            total=600;
        }
        else if(jComboBox3.getSelectedItem().equals("Rajwadi  9:00PM  7:45 Hour 550/-")){
            total=550;
        }
        else if(jComboBox3.getSelectedItem().equals("Ronak Travels 10:00PM 9:00 Hour 450/-")){
            total=450;
        }
        else if(jComboBox3.getSelectedItem().equals("New Samay AC-Class 9:20PM 8:00 Hour 700/-")){
            total=700;
        }
